...
async def start_money(message: types.Message):
    ...
    if  look_user_get:
        ...
        if subs:
            ...
            web_subs = [sub for sub in subs if sub["keyword"] == "WEB-разработка"]
            if not web_subs:
                ...
                if end_date < now:
                    ...
                    async def new_message(message: types.Message):
                        ...
                        if message.chat.id in agent_id:
                            ...
                            unique_users = set(user['user_id'] for user in subs if user['keyword'] == 'WEB-разработка')
                            ...
                            for sub in unique_users:
                                ...
                                web_subs_1 = [sub for sub in subs if sub["keyword"] == "WEB-разработка"]
                                if not web_subs_1:
                                    continue
                                else:
                                    web_sub = web_subs[0]
